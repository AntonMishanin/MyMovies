...
import com.my.movies.feed.di.FeedComponentViewModel
import com.my.movies.feed.di.FeedViewModelFactory
...
class FeedFragment : Fragment() {
    ...
    @Inject
    internal lateinit var feedViewModelFactory: FeedViewModelFactory
